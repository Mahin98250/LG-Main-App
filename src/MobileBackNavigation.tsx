...
export default function MobileBackNavigation() {
  ...
  useEffect(() => {
    ...
    const onTouchEnd = (event: TouchEvent) => {
      ...
      // App-controlled middle-screen swipe: rightward, intentional, mostly horizontal.
  ...
  return (
    <>
      ...
      <button
        type="button"
        aria-label="Back navigation settings"
          ...
          {(["arrow", "swipe"] as BackMode[]).map((option) => (
            <button
              ...
              style={{
                ...
                border: 0,
                borderRadius: 10,
                background: mode === option ? "rgba(255,255,255,.14)" : "transparent",
                color: "white",
                textAlign: "left",
                cursor: "pointer",
                fontSize: 14,
