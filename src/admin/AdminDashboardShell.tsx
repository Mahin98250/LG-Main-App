    ...
    >
      ...
      >
        ...
        >
          ...
          <div>
            <b style={{ display: "block", fontSize: 17 }}>Learner's</b>
            <b style={{ color: "#F5A623", fontSize: 17 }}>Guide</b>
          </div>
        </div>
        <div style={{ color: "#EF4444", fontSize: 11, fontWeight: 900, padding: "14px 10px 8px" }}>
          ● ADMIN PANEL
        </div>
        <nav>
          {NAV.map(([view, icon, label]) => (
            <button
              ...
              style={{
                ...
                gap: 12,
                cursor: "pointer",
                fontWeight: view === "dashboard" ? 800 : 600,
              }}
            >
