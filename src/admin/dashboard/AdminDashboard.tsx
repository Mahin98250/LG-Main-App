...
export default function AdminDashboard() {
  ...
  return (
    <div style={{ padding: 28, overflowY: "auto" }}>
      {error && (
        <div style={{ ...cardStyle, marginBottom: 18, color: C.red, borderColor: `${C.red}55` }}>
          {error}
        </div>
      )}
      ...
      >
        ...
        <StatCard
          ...
          color={C.red}
          sub={`₹${metrics.pendingAmt.toLocaleString("en-IN")}`}
          delay="fu d4"
        />
        <StatCard
          icon="📝"
                ...
                <div style={{ width: "100%", height: 82, display: "flex", alignItems: "flex-end" }}>
                  <div
                    style={{
                      ...
                      background: `linear-gradient(180deg,${C.accent},#7B91F5)`,
          ...
          {[
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <div
                  style={{ width: 10, height: 10, borderRadius: "50%", background: String(color) }}
                />
                <span style={{ fontSize: 14, color: C.text, fontWeight: 600 }}>{label}</span>
              </div>
              <span style={{ fontSize: 15, fontWeight: 800, color: String(color) }}>
