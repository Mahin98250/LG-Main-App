...
function Index() {
  ...
  if (checkingSession) return <div style={{ minHeight: "100vh", display: "grid", placeItems: "center", fontFamily: "Poppins, sans-serif", color: "#1a1060", padding: 24 }}>Restoring your saved login…</div>;
  return <RoleSelect onNext={(role: Role) => navigate({ to: "/auth", search: { role } })} />;
}
