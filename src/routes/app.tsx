...
function AppShell() {
  ...
  if (loadError) {
    return <Splash label={loadError} action={<button onClick={load} style={{ border: 0, borderRadius: 12, padding: "11px 18px", background: "#fff", color: "#1a1060", fontWeight: 800, cursor: "pointer" }}>Retry</button>} />;
  }
